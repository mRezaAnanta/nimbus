...
export const id: RegionText = {
	...
	intro: [
		'Anggap kamu punya banyak pengguna di <b>Argentina</b>. Server-mu harus ditaruh di salah satu lokasi data center milik penyedia cloud.',
		...
		'Coba taruh server-mu di beberapa kota, lalu lihat <b>latensinya</b> (waktu data bolak-balik).'
	],
	reactions: {
