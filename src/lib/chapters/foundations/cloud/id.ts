...
export const id: CloudText = {
	title: 'Apa itu cloud?',
	intro: [
		'Server tadi harus ditaruh di suatu tempat. Ada dua cara: kelola sendiri (disebut <b>on-premise</b>) atau sewa di <b>cloud</b>.',
		...
		'Biar kerasa bedanya, coba klik dua-duanya: taruh server sendiri vs sewa di cloud.'
	],
	reactions: {
