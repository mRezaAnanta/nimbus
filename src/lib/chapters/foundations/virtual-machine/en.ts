...
export const en: VirtualMachineText = {
	...
	reactions: {
		first:
			'One cut, and VM 1 instantly got its own share, 2 vCPU and 4 GB, complete with its own operating system. It believes it is a whole computer, yet it is only a slice.',
