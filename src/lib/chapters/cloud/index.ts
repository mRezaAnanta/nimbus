...
export const cloudChapter: Chapter = {
	...
	summary: {
		id: {
			...
			items: [
				'<b>Cloud</b> berarti menyewa komputer di data center dan bayar sesuai pakai, bukan sesuatu yang ajaib di langit',
		...
		en: {
			...
			items: [
				'<b>Cloud</b> means renting computers in a data center and paying as you go, not something magical in the sky',
