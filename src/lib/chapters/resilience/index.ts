...
export const resilience: Chapter = {
	...
	lessons: [availabilityZone, failover, storageTypes, database, replication],
	summary: {
		id: {
			title: 'Bab 3 selesai',
			...
			items: [
				...
				'<b>Replikasi</b> untuk pengambilalihan hidup saat gangguan, <b>backup</b> untuk memulihkan dari kesalahan'
			],
			nextNote:
