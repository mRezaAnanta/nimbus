...
export const resilience: Chapter = {
	...
	lessons: [availabilityZone, failover],
	summary: {
		id: {
			title: 'Bab 2 selesai',
			...
			items: [
				...
				'Siapkan <b>server cadangan</b>; kalau yang utama mati, trafik otomatis pindah (<b>failover</b>)'
			],
			nextNote:
		...
		en: {
			...
			items: [
				...
				'Keep a <b>standby server</b>; if the primary dies, traffic switches over automatically (<b>failover</b>)'
			],
			nextNote:
